    ...
    if (!product) {
        return (
            <div className="container mx-auto px-4 py-12 text-center ">
                <h2 className="text-2xl text-primary_yellow">
                    Product not found
                </h2>
                <Link
                    to="/"
        ...
        <div className="w-[80%] mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
                ...
                <div className="col-span-2">
                    ...
                    <div className="bg-primary_brown rounded-lg p-6 mb-8">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <span className="text-white">
                                Thời gian chuẩn bị:{" "}
                                {product.details.preparationTime}
                            </span>
                        </div>
                    ...
                    <button className="w-full items-center mt-8 group relative px-8 py-4 bg-primary-yellow text-primary-brown rounded-lg text-lg font-semibold overflow-hidden transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,196,4,0.4)] bg-primary_yellow">
                        <img
                            src={CartIcon}
                            alt="cartitem"
